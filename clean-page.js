(() => {
  ...
  const shellCss = `
    ...
    .more-toggle{display:inline-flex;align-items:center;justify-content:center;gap:7px;min-height:40px;padding:9px 12px;border:1px solid rgba(255,255,255,.10);border-radius:13px;background:rgba(255,255,255,.055);color:#fff;font:800 12px "Plus Jakarta Sans",sans-serif;cursor:pointer;transition:.22s;white-space:nowrap}
    .more-toggle:hover,.more-toggle[aria-expanded="true"]{background:rgba(18,104,255,.22);border-color:rgba(16,200,255,.35);transform:translateY(-1px)}
    .more-toggle i{color:#b9d3ff;font-size:13px}
    .more-drawer{display:none;position:absolute;top:48px;right:0;min-width:210px;padding:9px;border-radius:16px;background:rgba(14,13,56,.99);border:1px solid rgba(255,255,255,.12);box-shadow:0 20px 55px rgba(0,0,0,.32);z-index:150}
