(() => {
  ...
  const shellCss = `
    ...
    .more-toggle{display:inline-flex;align-items:center;justify-content:center;width:40px;height:40px;padding:0;border:1px solid rgba(255,255,255,.10);border-radius:13px;background:rgba(255,255,255,.055);color:#fff;cursor:pointer;transition:.22s}
    ...
    .more-toggle i{color:#b9d3ff;font-size:16px}
